/****************************************************************************************************************************
  AsyncFSWebServer_Teensy41.hpp - Dead simple AsyncFSWebServer for Teensy41 QNEthernet
...
#define ASYNC_FSWEBSERVER_TEENSY41_VERSION           "AsyncFSWebServer_Teensy41 v1.4.1"

#define ASYNC_FSWEBSERVER_TEENSY41_VERSION_MAJOR     1
#define ASYNC_FSWEBSERVER_TEENSY41_VERSION_MINOR     4
#define ASYNC_FSWEBSERVER_TEENSY41_VERSION_PATCH     1

#define ASYNC_FSWEBSERVER_TEENSY41_VERSION_INT       1004001
...
#include "AsyncFS_StringArray_Teensy41.h"
...
class AsyncWebServerRequest
{
  ...
  public:
    ...
    bool isExpectedRequestedConnType(RequestedConnectionType erct1, 
                   RequestedConnectionType erct2 = RCT_NOT_USED, RequestedConnectionType erct3 = RCT_NOT_USED);
...
class AsyncWebRewrite
{
  ...
  public:
    ...
    virtual inline bool match(AsyncWebServerRequest *request)
    {
...
class AsyncWebHandler
{
  ...
  public:
    ...
    virtual inline bool canHandle(AsyncWebServerRequest *request __attribute__((unused)))
    {
      return false;
    }
    ...
    virtual inline bool isRequestHandlerTrivial()
    {
      return true;
    }
};
...
class DefaultHeaders
{
  ...
  public:
    ...
    static inline DefaultHeaders &Instance()
    {
...
#include "AsyncFSWebResponseImpl_Teensy41.h"
#include "AsyncFSWebHandlerImpl_Teensy41.h"
#include "AsyncFSWebSocket_Teensy41.h"
#include "AsyncFSEventSource_Teensy41.h"
