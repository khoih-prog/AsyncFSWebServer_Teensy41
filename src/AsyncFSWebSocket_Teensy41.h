/****************************************************************************************************************************
  AsyncFSWebSocket_Teensy41.h - Dead simple AsyncFSWebServer for Teensy41 QNEthernet
...
#include "AsyncFSWebSynchronization_Teensy41.h"
...
class AsyncWebSocketMessage
{
  ...
  public:
    ...
    virtual inline size_t send(AsyncClient *client __attribute__((unused)))
    {
      return 0;
    }

    virtual inline bool finished()
    {
      return _status != WS_MSG_SENDING;
    }

    virtual inline bool betweenFrames() const
    {
      return false;
    }
};
...
class AsyncWebSocketBasicMessage: public AsyncWebSocketMessage
{
  ...
  public:
    ...
    virtual inline bool betweenFrames() const override
    {
      return _acked == _ack;
    }
